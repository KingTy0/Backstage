...
private static void SeedProducts(ApplicationDbContext context)
{
    ...
    if (!context.Products.Any())
    {
        ...
        // Product 3 Puppet fest Black T shirt
        var PuppetFestBlackShirtParent = new Product
        {
            Name = "Puppet Fest Logo Black T-Shirt",
            Description = "Sport the Festival logo in classic puppeteer black! Includes Gildan and Next Level brand options.",
            Price = 20.00m,
        ...
        //Define the sizes for the varients 
        ...
        foreach (var size in blackTSize)
            {
                var variant = new Product
                {
                    ...
                    ParentProductId = PuppetFestBlackShirtParent.Id,
                    Size = size,
                    Price = 20.00m,
                    Color = ProductColor.Black,
                    CategoryId = 1,
                ...
                context.SaveChanges();
                    ...
                    // Seed 20 units of each size to reach ~100 total
                 context.ProductLocations.Add(new ProductLocation { ProductId = variant.Id, LocationId = 1, Quantity = 20 });
